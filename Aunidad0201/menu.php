...
<body>
    ...
    <div class="cont1">
        <h3 class="p3">Menú del día</h3>
            <ul class="p1">
                <li><a href="menu.php?sugerencia=1">Sugerencias: carnes</a></li>
                <li><a href="menu.php?sugerencia=2">Sugerencias: vegetales</a></li>
                <li><a href="menu.php?sugerencia=3">Sugerencias: pastas</a></li>
            </ul>
    </div>
    <?php 
        $plato_ppal="";
