...
try {
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        mysqli_query(conexion(), "INSERT INTO reservas VALUES (DEFAULT, '$apellidos','$nombres','$email','$telefono','$cantidad_p','$fecha','$hora') ");
